...
export default function MyTransactionsAll({ user }) {
  ...
  useEffect(() => {
    ...
    const dateList = [];
    const hashList = [];
    const requestOpt = getRequest({ who: "from", address: account });
    fetch("http://localhost:5000/api/detail/txId", requestOpt)
